...
const pricing = [
  ...
  },
  {
    ...
    items: ["Full breakdown across key areas", "Identify patterns and friction points", "Understand what is actually driving things", "Clear next steps and action plan"],
    details: [
      "A guided one-question-at-a-time audit across identity, emotional stability, health, discipline, relationships, clarity, direction, and alignment.",
      "Section transitions, reflection moments, and The Auditor support layer to help users think more honestly and go one layer deeper.",
      "A fuller diagnostic output with category scores, root issue, repeated themes, friction points, and the pattern most affecting behaviour.",
      "A practical report designed to feel closer to condensed coaching than a generic quiz result.",
    ],
    cta: "Continue to Members Access",
    featured: true,
    value: "One session. No ongoing coaching. Just clarity on what's actually going on and what to do next.",
